...
import KeccakBlackBoxEngine from "./components/KeccakBlackBoxEngine";
  ...
  return (
    <Router>
      <AppContainer>
        ...
        {/* Header */}
        <Header>
          <h1>ICONOCLAST Keccak BlackBox Engine </h1>
        </Header>
        ...
        <MainContent>
          <TopSection>
            ...
            <h2>Glad you made it! Lets make an impact together! </h2>
            <Routes>
              <Route path="/instruction-page" element={<InstructionPage />} />
              <Route path="/sidebar" element={<Sidebar />} />
              <Route path="/KeccakBlackBoxEngine" element={<KeccakBlackBoxEngine />} />
